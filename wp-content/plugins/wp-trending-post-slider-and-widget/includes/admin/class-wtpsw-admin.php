...
class Wtpsw_Admin {
	...
	function wtpsw_register_menu() {
		...
		add_submenu_page( 'wtpsw-settings', __('Upgrade to PRO - Trending/Popular Post Slider and Widget', 'wtpsw'), '<span style="color:#ff2700">'.__('Upgrade to PRO', 'wtpsw').'</span>', 'manage_options', 'wtpsw-premium', array($this, 'wtpsw_premium_page') );
	}
