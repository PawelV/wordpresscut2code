...
<div class="wrap">
	...
	<h2><?php _e( 'WP Trending Post Slider and Widget with ', 'wtpsw' ); ?><span class="wpos-epb"><?php _e( 'Essential Plugin Bundle', 'wtpsw' ); ?></span></h2><br />
	<style>
				...
				<table class="wpos-plugin-pricing-table">
					...
					<thead>
						<tr>
							...
							<th>
								...
								<p>Gain access to <strong>WP Trending Post Slider and Widget</strong> included in <br /><strong class="wpos-epb">Essential Plugin Bundle</strong></p>
								<a href="<?php echo WTPSW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Trending&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
							</th>
						</tr>
					</thead>
					...
					<tfoot>
						<tr>
							<th></th>
							<td></td>
							<td><p>Gain access to <strong>Trending/Popular Post Slider and Widget</strong> included in <br /><strong>Essential Plugin Bundle</strong></p>
							<a href="<?php echo WTPSW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Trending&utm_campaign=Upgrade-PRO" target="_blank">Buy Now</a>
						</tr>
					</tfoot>
				...
				<!--Upgrad to Pro HTML -->
					<div id="postbox-container-1" class="postbox-container wpos-sidebar">
						<div class="wpos-epb-wrap">
							...
							<ul>
								<li><b>40+ Utility Plugins</b> including <span><?php echo WTPSW_NAME; ?> premium </span> version.</li>
							...
							<a class="button-yellow button-orange" style="margin-bottom:0px;" href="<?php echo WTPSW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Trending&utm_campaign=EPB-Upgrade-PRO" target="_blank">Buy Now</a>
						</div>
