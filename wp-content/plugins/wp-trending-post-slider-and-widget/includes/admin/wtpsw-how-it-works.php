						...
						<div class="meta-box-sortables">
							...
							<div class="postbox">
								...
								<div class="inside">
									...
									<a class="button button-primary button-orange" href="<?php echo WTPSW_SITE_LINK; ?>/essential-bundle/?utm_source=WP&utm_medium=Trending&utm_campaign=Check-Designs-Solutions" target="_blank"><?php _e('Boost Design', 'wtpsw'); ?></a>
								</div><!-- .inside -->
							</div><!-- #general -->
						...
						<div class="meta-box-sortables">
							<div class="postbox">
								...
								<div class="inside">
									...
									<a class="button button-primary wpos-button-full button-orange" href="<?php echo WTPSW_SITE_LINK; ?>/pricing/?utm_source=WP&utm_medium=Trending&utm_campaign=Upgrade-PRO" target="_blank"><?php _e('Go Premium ', 'wtpsw'); ?></a>	
									<p><a class="button button-primary wpos-button-full" href="http://demo.wponlinesupport.com/prodemo/pro-featured-and-trending-post/" target="_blank"><?php _e('View PRO Demo ', 'wtpsw'); ?></a></p>
								</div><!-- .inside -->
							</div><!-- #general -->
